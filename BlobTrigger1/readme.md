...
[Developer guide](https://pythondeveloperguide.azurewebsites.net/#blob-storage-bindings)

[API reference](https://pythondeveloperguide.azurewebsites.net/api.html#blob-bindings)